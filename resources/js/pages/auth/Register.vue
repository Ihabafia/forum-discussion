        ...
        <form class="flex flex-col gap-4" @submit.prevent="submit">
            <div class="grid gap-6">
                <div class="grid gap-2">
                    ...
                    <Input id="username" v-model="form.username" :tabindex="1" autofocus maxlength="25" placeholder="Username" required type="text" />
                    <InputError :message="form.errors.username" />
                </div>
                <div class="grid gap-2">
                    <Label for="name">Name</Label>
                    <Input id="name" v-model="form.name" :tabindex="2" autocomplete="name" placeholder="Full name" required type="text" />
            ...
            <div class="text-muted-foreground text-center text-sm">
                <TextLink :href="route('home')" :tabindex="8" class="underline underline-offset-4">Back Home</TextLink>
            </div>
        </form>
    </AuthBase>
</template>
